...
import com.codigo.clinica.mspaciente.infraestructure.dao.TeatmentRepository;
...
import com.codigo.clinica.mspaciente.infraestructure.mapper.TeatmentMapper;
...
public class TeatmentAdapter implements TeatmentServiceOut {
    ...
    public Optional<TeatmentDto> findByIdOut(Long id) {
        ...
        if(redisInfo != null){
            ...
            teatmentDto = TeatmentMapper.fromEntity(teatmentRepository.findById(id).orElseThrow(()-> new RuntimeException("Tratamiento no encontrado.")));
    ...
    private Teatment getEntity(Teatment entity, TeatmentRequest teatmentRequest, boolean updateIf, Long id){
        ...
        Patient patient = patientRepository.findById(teatmentRequest.getPatientId()).orElseThrow(()-> new RuntimeException("Paciente no encontrado."));
